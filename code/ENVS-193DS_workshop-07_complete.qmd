...
library(here) # file/folder organization, the code and the data
...
# telling r to look into the data folder for the abalone data file
abalone <- read_xlsx(here("data", "Abalone IMTA_growth and pH.xlsx"))

# Sonadora temperature data from Alonzo, A. 2024
# telling r to look into the data folder for the tmeperature data file
...
ggplot(data = abalone_clean,
  ...
  geom_point(size = 4,
             ...
             shape = 21) +
  theme_minimal() +
  labs(x = "pH", y= "Change in shall surface area per day")
